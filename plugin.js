...
(function ($) {
    ...
    $.fn.Chocolat = function (settings) {
        ...
        function _interface() {
            clear();
            settings.container.append('<div id="Choco_overlay"></div><div id="Choco_content"><div id="Choco_loading"></div><div id="Choco_container_photo"><img id="Choco_bigImage" src="" /></div><div id="Choco_left_arrow" class="Choco_arrows icon-arrow-left"></div><div id="Choco_right_arrow" class="Choco_arrows icon-arrow-right"></div></div>');
            ...
            if (settings.linkImages) {
                ...
                for (var i = 0; i < what.length; i++) {
                    ...
                    if (what[i] == "Choco_right_arrow" && settings.currentImage == settings.lastImage) {
                        ...
                        if (what[i] == "Choco_left_arrow" && settings.currentImage == 0) {
                            hide = true;
                            $("#" + what[i]).fadeOut(300)
                        }
                    }
        ...
        function close() {
            $("#Choco_overlay").fadeOut(500, function () {
                $("#Choco_overlay").remove()
            });
